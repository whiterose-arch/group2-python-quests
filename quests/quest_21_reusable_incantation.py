...
Why it matters
--------------
Functions let you package up code you want to reuse (the 'Don't Repeat Yourself' principle).

Logical reasoning
------------------
Instead of copying and pasting code, I'll put it in a function and 'call' it by name.
...
# Remember: keep it simple, test it by running `python quest_21_reusable_incantation.py`,
